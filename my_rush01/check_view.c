...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/10/07 20:22:15 by aafuni            #+#    #+#             */
/*   Updated: 2023/10/07 20:22:59 by aafuni           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include <stdio.h>
#define SIZE 6
...
int	main(void)
{
	int matrix[6][6] = {{0, 4, 3, 2, 1, 0},
						...
						{1, 0, 0, 2, 0, 2},
						{0, 1, 2, 3, 2, 0}};
	printf("row left: %i\n", check_row_left(1, 1, matrix));
	printf("row right: %i\n", check_row_right(1, 1, matrix));
	printf("column up: %i\n", check_column_up(1, 1, matrix));
	printf("column down: %i\n", check_column_down(1, 1, matrix));
	printf ("check view: %i\n", check_view (1, 1, matrix));
}
*/
